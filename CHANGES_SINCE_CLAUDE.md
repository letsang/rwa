...
- grille des classes finalisée en quatre colonnes ; les trois cellules de race
  utilisent la largeur calculée d'une colonne de classe, soit
  `(largeur disponible - 3 espacements) / 4`, et conservent la même hauteur ;
